...
$querySetting = mysqli_query($koneksi, "SELECT * FROM setting LIMIT 1");
...
if (isset($_POST['simpan'])) {
    ...
    if ($row) {
        ...
        $update = mysqli_query($koneksi, "UPDATE setting SET email = '$email', phone = '$phone', alamat = '$alamat', instagram = '$instagram', facebook = '$facebook', twitter = '$twitter', linkedin = '$linkedin', logo = '$logo_name' WHERE id = '$id_setting'");
        if ($update) {
